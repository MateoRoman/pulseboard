...
**Nota sobre `JAVA_HOME`**: no está definido en el entorno. `mvnw.cmd` lo consulta antes de
recurrir al `java` del `PATH`. Si el primer arranque falla indicando que no encuentra el
JDK:
